...
func (j *DeviceAddedNotificationJsonData) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["adapterId"]; !ok || v == nil {
		return fmt.Errorf("field adapterId in DeviceAddedNotificationJsonData: required")
	}
	if v, ok := raw["device"]; !ok || v == nil {
		return fmt.Errorf("field device in DeviceAddedNotificationJsonData: required")
	}
	if v, ok := raw["pluginId"]; !ok || v == nil {
		return fmt.Errorf("field pluginId in DeviceAddedNotificationJsonData: required")
	}
	type Plain DeviceAddedNotificationJsonData
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = DeviceAddedNotificationJsonData(plain)
	return nil
}
