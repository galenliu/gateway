let TimeoutError,ow;_794‍.x([["checkAddress",()=>checkAddress],["checkOptionalAddress",()=>checkOptionalAddress],["timed",()=>timed]]);_794‍.w("./errors",[["TimeoutError",["TimeoutError"],function(v){TimeoutError=v}]]);_794‍.w("ow",[["default",["ow"],function(v){ow=v}]]);
...
class CancelableTimeout {
  ...
  then(resolved, rejected) {
    ...
    return this._promise.catch(rejected);
       ...
       const checkAddress = ow.create('address', ow.string.length(6));
       const checkOptionalAddress = ow.create('address',
