let EventEmitter2,isMatch,ow,Modem,Commands,WorkQueue,EXTENDED_USERDATA_LENGTH,MessageNAKError,UnexpectedMessageError,timed,checkAddress;_71d‍.x([["MessageCommands",()=>MessageCommands],["Messenger",()=>Messenger]]);_71d‍.w("eventemitter2",[["EventEmitter2",["EventEmitter2"],function(v){EventEmitter2=v}]]);_71d‍.w("lodash/lang",[["isMatch",["isMatch"],function(v){isMatch=v}]]);_71d‍.w("ow",[["default",["ow"],function(v){ow=v}]]);_71d‍.w("./modem",[["Modem",["Modem"],function(v){Modem=v}],["Commands",["Commands"],function(v){Commands=v}]]);_71d‍.w("./workQueue",[["WorkQueue",["WorkQueue"],function(v){WorkQueue=v}]]);_71d‍.w("./protocol",[["EXTENDED_USERDATA_LENGTH",["EXTENDED_USERDATA_LENGTH"],function(v){EXTENDED_USERDATA_LENGTH=v}]]);_71d‍.w("./errors",[["MessageNAKError",["MessageNAKError"],function(v){MessageNAKError=v}],["UnexpectedMessageError",["UnexpectedMessageError"],function(v){UnexpectedMessageError=v}]]);_71d‍.w("./utils",[["timed",["timed"],function(v){timed=v}],["checkAddress",["checkAddress"],function(v){checkAddress=v}]]);
...
const DEFAULT_FLAGS = {
  ...
  READ_WRITE_LINKS: 0x2f,
       ...
       class Messenger extends EventEmitter2 {
  constructor(modem) {
