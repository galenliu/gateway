_541‍.x([["CommandNAKError",()=>CommandNAKError],["MessageNAKError",()=>MessageNAKError],["TimeoutError",()=>TimeoutError],["UnexpectedMessageError",()=>UnexpectedMessageError]]);class CommandNAKError extends Error {
  constructor(frame) {
    ...
    this.name = 'CommandNAKError';
       ...
       class MessageNAKError extends Error {
  constructor(msg) {
