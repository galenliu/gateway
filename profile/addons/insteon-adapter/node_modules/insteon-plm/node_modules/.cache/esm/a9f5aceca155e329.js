let SerialPort,EventEmitter2,frameFromBytes,frameToBytes,Commands,WorkQueue,CommandNAKError,timed;_a15‍.x([["Commands",()=>Commands],["Modem",()=>Modem]]);_a15‍.w("serialport",[["default",["SerialPort"],function(v){SerialPort=v}]]);_a15‍.w("eventemitter2",[["EventEmitter2",["EventEmitter2"],function(v){EventEmitter2=v}]]);_a15‍.w("./protocol",[["frameFromBytes",["frameFromBytes"],function(v){frameFromBytes=v}],["frameToBytes",["frameToBytes"],function(v){frameToBytes=v}],["Commands",["Commands"],function(v){Commands=v}]]);_a15‍.w("./workQueue",[["WorkQueue",["WorkQueue"],function(v){WorkQueue=v}]]);_a15‍.w("./errors",[["CommandNAKError",["CommandNAKError"],function(v){CommandNAKError=v}]]);_a15‍.w("./utils",[["timed",["timed"],function(v){timed=v}]]);
 ...
 */
       class Modem extends EventEmitter2 {
  ...
  _handleData(data) {
    ...
    try {
      ...
      if (!(error instanceof RangeError)) {
        _a15‍.g.console.error('Error parsing modem frame', error);
      }
    }
  }
}
