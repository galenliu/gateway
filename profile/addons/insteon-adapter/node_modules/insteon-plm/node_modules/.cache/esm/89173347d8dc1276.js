let Protocol;_d8d‍.x([["START",()=>START],["ACK",()=>ACK],["NAK",()=>NAK],["EXTENDED_USERDATA_LENGTH",()=>EXTENDED_USERDATA_LENGTH],["Commands",()=>Commands],["PLMProtocol",()=>PLMProtocol],["linkRecordFromBytes",()=>linkRecordFromBytes],["frameFromBytes",()=>frameFromBytes],["frameToBytes",()=>frameToBytes]]);_d8d‍.w("bin-protocol",[["default",["Protocol"],function(v){Protocol=v}]]);

       const START = 0x02;
       const ACK = 0x06;
       const NAK = 0x15;

       const EXTENDED_USERDATA_LENGTH = 14;
  ...
  GET_IM_CONFIG: 0x73
       ...
       const PLMProtocol = Protocol.createProtocol();
  ...
  write(frame) {
    ...
    case Commands.SEND_INSTEON: {
      ...
      break;
       ...
       function linkRecordFromBytes(data) {
